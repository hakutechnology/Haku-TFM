/**
 ...
 ==============================================================================
    [..]
      ...
      memory of all STM32WBAxx devices.
...
{
  if (READ_BIT(FLASH->NSCR1, FLASH_NSCR1_OPTLOCK) != 0U)
  {
...
HAL_StatusTypeDef HAL_FLASH_OB_Lock(void)
{
  ...
  SET_BIT(FLASH->NSCR1, FLASH_NSCR1_OPTLOCK);
...
HAL_StatusTypeDef HAL_FLASH_OB_Launch(void)
{
  ...
  SET_BIT(FLASH->NSCR1, FLASH_NSCR1_OBL_LAUNCH);
...
/**
  ...
  *            @arg @ref HAL_FLASH_ERROR_OPTW FLASH Option write error
  */
