...
#else
#define INTEGRITY_CHECKER_ERROR_BASE 0x1u
...
/**
 * \brief Arm Integrity Checker error enumeration types
 */
enum integrity_checker_error_t {
    INTEGRITY_CHECKER_ERROR_NONE = 0x0u,
    INTEGRITY_CHECKER_ERROR_UNSUPPORTED_MODE = INTEGRITY_CHECKER_ERROR_BASE,
    ...
    INTEGRITY_CHECKER_ERROR_CHECK_VALUE_INVALID_ARGUMENT,
    INTEGRITY_CHECKER_ERROR_FORCE_UINT_SIZE = UINT_MAX,
};
